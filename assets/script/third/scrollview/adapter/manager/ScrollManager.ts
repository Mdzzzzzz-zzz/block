...
import { VMEvent } from './ViewManagerEvent';
...
export class ScrollManager extends Manager {
    ...
    protected onInit(): void {
        ...
        this.adapter.viewManager.on(VMEvent.ON_UPDATE_VIEWS, this._onUpdateViews, this)
        this.adapter.viewManager.on(VMEvent.ON_CHANGED_VIRTUALSIZE, this._onChangedVirtualSize, this)
        this.adapter.viewManager.on(VMEvent.ON_CHANGED_OVERFLOWHEADER, this._onChangedOverflowHeader, this)
        this.adapter.viewManager.on(VMEvent.ON_RESET_ALL_STATE, this._onResetAllState, this)
        this.adapter.viewManager.on(VMEvent.ON_CLEARVIEWS, this._onResetAllState, this)
    ...
    private _onTouchMove(event: EventTouch, useCaptures: Node[]) {
        ...
        //console.log("localtion " + location + " startLocation " + startLocation)
    ...
    private _updateContentPosition(position: ILike, updatePercentage: boolean = true) {
        ...
        //console.log(" main adapter size " + this.adapter.mainAxisSize);
        // if (this._scrollDirection == ScrollDirection.Right) {
        //     console.log("turnRight " + Math.ceil(position.x / this.adapter.mainAxisSize) * this.adapter.mainAxisSize)
        //     this.content.node.setPosition(Math.ceil(position.x / this.adapter.mainAxisSize) * this.adapter.mainAxisSize, position.y);
        // } else if (this._scrollDirection == ScrollDirection.Left) {
        //     console.log("turnLeft " + Math.ceil(position.x / this.adapter.mainAxisSize) * this.adapter.mainAxisSize)
        //     this.content.node.setPosition(Math.floor(position.x / this.adapter.mainAxisSize) * this.adapter.mainAxisSize, position.y);
        // }
