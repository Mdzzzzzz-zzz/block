...
import { VMEvent } from '../manager/ViewManagerEvent';
...
export abstract class View<T = any, A extends ScrollAdapter<T> = ScrollAdapter<T>> {
    ...
    private register() {
        this.adapter.viewManager.on(VMEvent.ON_SCROLL, this._onScroll, this)
        this.adapter.viewManager.on(VMEvent.ON_LATEUPDATE, this._onLateUpdate, this)
    ...
    private unregister() {
        this.adapter.viewManager.off(VMEvent.ON_SCROLL, this._onScroll, this)
        this.adapter.viewManager.off(VMEvent.ON_LATEUPDATE, this._onLateUpdate, this)
