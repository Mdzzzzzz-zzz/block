...
import { Holder, IElement, ReleaseEvent, ReleaseManager, ReleaseState, ScrollAdapter, View } from '../../adapter';
import { chatItem } from "./chat_Item"
import { VMEvent } from '../../adapter/manager/ViewManagerEvent';
...
export class chat extends ScrollAdapter<IChatModel> {
    ...
    start() {
        ...
        this.viewManager.on(VMEvent.ON_MAGNETIC, this._onMagnetic, this)
    }
