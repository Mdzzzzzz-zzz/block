...
@ccclass("AdventureLevelConditionView")
export class AdventureLevelConditionView extends Component {
    @property(Label)
    labLevel: Label = null;
    @property(Node)
        ...
        if (this.manager.conditionType == emLevCondition.Score) {
            ...
            if (!this.isInScene) {
                if (this.manager.scoreHelper.score > 999) {
                    this.labScore.fontSize = 24;
                } else {
                    this.labScore.fontSize = 32;
                }
    ...
    public SetFromGameOver(bool) {
        this.fromGameOver = bool;
    }
        ...
        if (this.manager.conditionType == emLevCondition.Score) {
            ...
            if (scorecz > 0) {
                ...
                let call = tween(this.node).call(() => {
                    ...
                    if (tscore > 999) {
                        self.labScore.fontSize = 24;
                    } else {
                        self.labScore.fontSize = 32;
                    }
    ...
    restoreOrigin() {
        ...
        this.rootScoreCondition.scale = new Vec3(1.2, 1.2, 1.2);
